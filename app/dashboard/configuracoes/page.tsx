...
export default function ConfiguracoesPage() {
  ...
  const defaultPermissions = {
    modules: [
      ...
      { id: "relatorios", name: "Relatórios", view: false, full: false },
      ...
      { id: "abrirOrdemServico", name: "Ordem de Serviço - Abrir Nova OS", view: false, full: false },
    ],
    ordemServico: {
      id: "ordemServico",
  ...
  const pages = [
    ...
    { id: "abrirOrdemServico", name: "Ordem de Serviço - Abrir Nova OS" },
