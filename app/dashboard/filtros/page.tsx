    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Gerencie os filtros registrados para cada veículo</p>
          </div>
        <Button
          variant="outline"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {veiculosFiltrados.map((veiculo) => {
          ...
          return (
            <Card
            key={veiculo.id}
              className="hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/50 overflow-hidden group relative"
            >
              <div className="absolute top-3 right-3 z-10">
                {totalFiltros === 0 ? (
                  <div className="bg-yellow-500 rounded-full p-1.5 shadow-lg hover:bg-yellow-600 transition-colors" title="Nenhum filtro registrado ainda">
                    <Oil className="h-5 w-5 text-white" />
                  </div>
                ) : prontoParaTroca ? (
                  <div className="bg-green-500 rounded-full p-1.5 shadow-lg hover:bg-green-600 transition-colors" title="Pronto para troca de óleo - Todos os filtros com estoque">
                    <Oil className="h-5 w-5 text-white" />
                  </div>
                ) : (
                  <div className="bg-red-500 rounded-full p-1.5 shadow-lg hover:bg-red-600 transition-colors" title="Não está pronto - Algum filtro está sem estoque">
                    <Oil className="h-5 w-5 text-white" />
                  </div>
                )}
              </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <Badge variant="outline" className="font-bold text-base tracking-widest border-primary/30 bg-primary/5">
                {veiculo.placa}
                        </Badge>
                        <Badge 
                ...
                {estatisticasTrocaOleo[veiculo.id] && (estatisticasTrocaOleo[veiculo.id].kmAtual > 0 || estatisticasTrocaOleo[veiculo.id].kmProxTroca > 0) && (
                  <div className="mt-3 pt-3 border-t space-y-2">
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                      ...
                      <span className="font-medium">Troca de Óleo</span>
                    </div>
                    ...
                    {estatisticasTrocaOleo[veiculo.id].kmAtual > 0 && estatisticasTrocaOleo[veiculo.id].kmProxTroca > 0 && (
                      <div className="space-y-1">
                        <div className="flex items-center justify-between text-xs">
                          ...
                          <span className="font-semibold">{estatisticasTrocaOleo[veiculo.id].progresso}%</span>
                        </div>
                        <Progress 
              ...
              <CardFooter className="flex gap-2 pt-4">
                <Button 
                  variant="outline" 
                  className="flex-1 flex gap-2 items-center hover:bg-primary/5 hover:border-primary/50 transition-colors" 
                ...
                <Button 
                  variant="default" 
                  className="flex-1 flex gap-2 items-center shadow-md hover:shadow-lg transition-shadow" 
          ...
          <DialogHeader>
            ...
            {selectedVeiculo && (
              <div className="flex items-center gap-3 mt-2">
                <Badge variant="outline" className="font-bold text-sm tracking-widest">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {FILTER_HEADERS.map((header) => {
                ...
                return (
                  <Card key={header} className={`border-2 ${temFiltros ? 'border-primary/30' : 'border-muted'}`}>
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                        <h3 className="font-semibold text-sm text-foreground">{header}</h3>
                        {temFiltros && (
                    ...
                    <CardContent>
                      {!temFiltros ? (
                        <div className="flex flex-col items-center justify-center py-6 text-center">
                          ...
                          <span className="text-xs text-muted-foreground">Nenhum filtro registrado</span>
                        </div>
                      ) : (
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-center gap-2 flex-1 min-w-0">
                                  ...
                                  <span className="font-medium truncate" title={filtro.produtoDescricao}>
