...
import { Pencil, Trash2, Package, Tag, Ruler, MapPin, BarChart2, Eye, MoreVertical, PackageCheck } from "lucide-react"
...
export function ProdutoCard({ produto, onEdit, onDelete, onView, onAjustarEstoque }: ProdutoCardProps) {
  return (
