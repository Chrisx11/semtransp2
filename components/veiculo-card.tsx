...
export function VeiculoCard({ veiculo, onEdit, onDelete, onView }: VeiculoCardProps) {
  return (
    <Card className="h-full card-interactive animate-fade-in">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-muted-foreground line-clamp-1">{veiculo.modelo}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="flex items-center gap-2">
              <Badge variant={veiculo.status === "Ativo" ? "success" : "destructive"}>
                {veiculo.status}
              </Badge>
            </div>
          </div>
