...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-lg border shadow-sm">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm table-zebra", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors duration-150 hover:bg-muted/60 data-[state=selected]:bg-muted/80",
      className
    )}
    {...props}
  />
