  ...
  return (
    <div className="space-y-6 print:space-y-2">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="print:hidden">
        <TabsList className="ordem-tabslist-mobile flex w-full grid-cols-3 mb-2 sm:mb-4">
        ...
        {/* Aba de Informações */}
        <TabsContent value="informacoes" className="space-y-4 mt-2 sm:mt-4 px-1 sm:px-0 mb-6 sm:mb-0">
        ...
        <TabsContent value="detalhes" className="space-y-4 mt-2 sm:mt-4 px-1 sm:px-0 mb-6 sm:mb-0">
        ...
        {/* Aba de Histórico */}
        <TabsContent value="historico" className="space-y-4 mt-2 sm:mt-4 px-1 sm:px-0 mb-2 sm:mb-0">
          {/* Card de Observações */}
          {ordem.observacao2 && (
            <Card>
              <CardHeader className="pb-2">
      ...
      <style jsx global>{`
        ...
        @media (max-width: 768px) {
          .ordem-mobile-tabs > div:not(:last-child) {
            margin-bottom: 20px !important;
          }
          .ordem-mobile-tabs .Card { margin-bottom: 12px !important; }
        }
        @media (max-width: 768px) {
          .ordem-tabslist-mobile {
            display: flex !important;
            flex-direction: row;
            width: 100% !important;
          ...
          .ordem-tabslist-mobile button, .ordem-tabslist-mobile .TabsTrigger {
            flex: 1 1 0%;
            display: flex;
            align-items: center;
